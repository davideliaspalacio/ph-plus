  ...
  return (
    <section className="w-full bg-white">
      ...
      <div className="mx-auto max-w-[1100px] px-5 py-5 sm:px-8 sm:py-12 lg:hidden">
        ...
        <p className="ph-condensed mt-2 text-center text-[16px] font-bold leading-tight text-[#6b7280] sm:mt-7 sm:text-[28px]">
        ...
        <div className="mx-auto mt-3 grid max-w-[330px] grid-cols-[119px_1fr] items-center gap-3 sm:mt-9 sm:max-w-none sm:grid-cols-1 sm:gap-8">
          ...
          <div className="ph-condensed mx-auto w-full max-w-[640px] rounded-[20px] bg-[#1e3a8a] px-3 py-3 text-white shadow-[0_8px_24px_rgba(30,58,138,0.18)] sm:rounded-[26px] sm:px-8 sm:py-7">
            ...
            <p className="mt-3 text-right text-[12px] font-bold leading-none sm:mt-7 sm:text-left sm:text-[26px]">
              Sirley Montoya
            </p>
          </div>
        </div>
        ...
        <div className="mt-3 flex justify-center sm:mt-9">
          <Link
            ...
            className="ph-condensed inline-flex min-h-[30px] items-center justify-center rounded-[18px] border-2 border-[#1e3a8a] bg-white/10 px-4 text-[10px] font-bold leading-none text-[#6b7280] shadow-[3px_4px_0_rgba(0,0,0,0.35)] transition-transform hover:-translate-y-0.5 sm:min-h-[40px] sm:px-6 sm:text-[16px]"
          >
      ...
      <div className="mx-auto hidden max-w-[1100px] px-6 py-14 lg:block">
        <div className="grid grid-cols-[340px_1fr] items-center gap-12">
          ...
          <div>
            ...
            <p className="ph-condensed mt-4 text-[34px] font-bold leading-tight text-[#6b7280]">
              Cuando más lo necesitaba, PH PLUS estaba ahí.
            </p>

            <div className="ph-condensed mt-6 w-full rounded-[26px] bg-[#1e3a8a] px-8 py-7 text-white shadow-[0_8px_24px_rgba(30,58,138,0.18)]">
              <p className="text-[28px] font-bold leading-[1.28]">{QUOTE}</p>
              <p className="mt-7 text-[28px] font-bold leading-none">
                Sirley Montoya
              </p>
            </div>
            ...
            <div className="mt-6 flex justify-center">
              <Link
                href="/por-que-ph-plus#testimonios"
                className="ph-condensed inline-flex min-h-[44px] items-center justify-center rounded-[28px] border-2 border-[#1e3a8a] bg-white/10 px-7 text-[18px] font-bold leading-none text-[#6b7280] shadow-[3px_4px_0_rgba(0,0,0,0.35)] transition-transform hover:-translate-y-0.5"
              >
                Conoce más historias reales
              </Link>
            </div>
